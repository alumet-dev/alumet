...
fn create_files(root: &PathBuf) -> anyhow::Result<()> {
...
fn create_folder(root: &PathBuf, name: &str) -> anyhow::Result<()> {
...
fn create_cgroupv2_tree_slurm_empty(root: &PathBuf) -> anyhow::Result<()> {
    create_files(&root)?;
...
fn create_cgroupv2_tree_slurm_job(root: &PathBuf) -> anyhow::Result<()> {
...
fn create_cgroupv2_tree_slurm_jobs(root: &PathBuf) -> anyhow::Result<()> {
