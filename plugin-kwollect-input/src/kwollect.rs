...
// The same as one in kwollect-ouptput
...
// Here, the main idea is to do contrary of the Kwollect Output Plugin : to deserialize
/// Converts a JSON Value into a specific AttributeValue enum variant, depending on its type (bool, number, or string).
...
/// Parses a JSON array of measurements and returns a vector of MeasureKwollect objects, skipping any invalid entries.
