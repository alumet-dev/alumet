...
The TDP (Thermal Design Power) is the maximum amount of heat generated by a computer compnent. 
...
In the first version of the plugin, we consider only the TDP of the CPU.
 ...
 energy estimation = cgroupv2_cpu_total_usage * nb_vcpu/nb_cpu * tdp / 1000 000 / polling_interval
...
local@edge-master:~/manu/git/alumet$ kubectl  describe node edge-master.seed | grep cpu -B 2
  Hostname:    edge-master.seed
Capacity:
  cpu:                32
