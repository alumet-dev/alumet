...
mod tests {
    ...
    // #[tokio::test]
    // async fn test_register_new_metrics() {
    //     let metric_correspondence_table = Arc::new(RwLock::new(HashMap::<RawMetricId, RawMetricId>::new()));
    //     let new_metrics = vec![
    //         Metric{
    //             name: "test-metric".to_string(),
    //             unit: PrefixedUnit { base_unit: Unit::Watt, prefix: UnitPrefix::Plain },
    //             description: "This is a test metric".to_string(),
    //             value_type: WrappedMeasurementType::U64,
    //         }
    //     ];
    //     let old_ids = vec![RawMetricId::from_u64(18624)];

    //     let builder = Builder::new();
    //     let metric_registry_control = MetricRegistryControl::new(builder.metrics());

    //     // let mut metric_sender = MetricSender{};

    //     // register_new_metrics(
    //     //     metric_sender: &mut MetricSender,
    //     //     new_metrics:Vec<Metric>,
    //     //     old_ids: Vec<RawMetricId>,
