...
|----|----|----|-----------|----------|-----------------|
|`rapl_consumed_energy`|Counter Diff|joule|Energy consumed since the previous measurement|[domain](#domain-attribute-rapl_consumed_energy)||

### Domain attribute (rapl_consumed_energy)

The `rapl_consumed_energy` metric is classified by the `domain` attribute.
