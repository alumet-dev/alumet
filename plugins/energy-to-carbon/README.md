...
`Emission_Intensity` can be computed using several methods. This plugin supports 3 modes, each relying on a different `IntensityProvider` to handle the computation.
