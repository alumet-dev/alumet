...
pub struct Metrics {
    ...
    pub gpu_energy_consumption: TypedMetricId<u64>,
...
impl Metrics {
    pub fn new(alumet: &mut AlumetPluginStart) -> Result<Self, MetricCreationError> {
        Ok(Self {
            gpu_energy_consumption: alumet.create_metric::<u64>(
