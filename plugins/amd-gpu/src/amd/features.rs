use rocm_smi_lib::{
    RSMI_POWER_TYPE, RocmErr, rsmi_activity_metric_counter_t, rsmi_activity_metric_t_RSMI_ACTIVITY_GFX,
    rsmi_activity_metric_t_RSMI_ACTIVITY_MM, rsmi_activity_metric_t_RSMI_ACTIVITY_UMC,
    rsmi_compute_process_info_by_device_get, rsmi_compute_process_info_get, rsmi_dev_activity_metric_get,
    rsmi_dev_energy_count_get, rsmi_dev_memory_usage_get, rsmi_dev_power_get, rsmi_dev_temp_metric_get,
    rsmi_dev_volt_metric_get, rsmi_memory_type_t, rsmi_memory_type_t_RSMI_MEM_TYPE_GTT,
    rsmi_memory_type_t_RSMI_MEM_TYPE_VRAM, rsmi_process_info_t, rsmi_status_t, rsmi_status_t_RSMI_STATUS_SUCCESS,
    rsmi_temperature_metric_t, rsmi_temperature_metric_t_RSMI_TEMP_CURRENT,
    rsmi_temperature_type_t_RSMI_TEMP_TYPE_EDGE, rsmi_temperature_type_t_RSMI_TEMP_TYPE_HBM_0,
    rsmi_temperature_type_t_RSMI_TEMP_TYPE_HBM_1, rsmi_temperature_type_t_RSMI_TEMP_TYPE_HBM_2,
    rsmi_temperature_type_t_RSMI_TEMP_TYPE_HBM_3, rsmi_temperature_type_t_RSMI_TEMP_TYPE_JUNCTION,
    rsmi_temperature_type_t_RSMI_TEMP_TYPE_MEMORY, rsmi_voltage_metric_t, rsmi_voltage_metric_t_RSMI_VOLT_CURRENT,
    rsmi_voltage_type_t, rsmi_voltage_type_t_RSMI_VOLT_TYPE_FIRST,
};
