...
use amdsmi::{
    amdsmi_get_energy_count, amdsmi_get_gpu_activity, amdsmi_get_gpu_compute_process_info,
    amdsmi_get_gpu_compute_process_info_by_pid, amdsmi_get_gpu_device_bdf,
    amdsmi_get_gpu_memory_usage, amdsmi_get_power_info, amdsmi_get_processor_handles,
    amdsmi_get_socket_handles, amdsmi_get_temp_metric, amdsmi_is_gpu_power_management_enabled,
