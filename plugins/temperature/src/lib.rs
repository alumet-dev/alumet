...
use crate::temperature_sensors::SensorsFeature;
    ...
    fn start(&mut self, alumet: &mut AlumetPluginStart) -> anyhow::Result<()> {
        ...
        alumet.add_autonomous_source_builder("temperature_autonomous_source", move |_ctx, cancel_token, tx| {
            ...
            let handle = thread::spawn(move || {
                ...
                let sensors_feature_list: Vec<SensorsFeature> =
                    temperature_sensors::get_coretemp_feature_list(&lmsensors, package_only);
